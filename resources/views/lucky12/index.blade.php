    ...
    <div class="row w-100">
        <div class="col-md-12">
            <div class="white_shd full margin_bottom_30" style="width: 100%;">
                ...
                <div class="row" style="padding: 10px; position: relative; margin-bottom: 20px;"> <!-- Added margin-bottom to separate from the cards -->
                ...
                <!-- Row to display numbers 1 to 16 -->
                ...
                <form action="{{ route('lucky12.index') }}" method="post">
                    @csrf
                    ...
                    <div class="row justify-content-center" style="margin-bottom: 10px;">
                        <div class="col-md-3 form-group d-flex">
                            <input type="text" name="game_no" class="form-control" placeholder="Game Period Number" value="1001" style="font-size: 12px;">
                        </div>
